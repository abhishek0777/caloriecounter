  ...
  <span class="text1"><i>Welcome to Calorie Management</i></div>
     ...
     <div class="content">
          ...
          <div class= "clower">
              ...
              <p><b> <i class="fa fa-paper-plane-o"></i>Body Mass Index:<?php echo $_SESSION['bmi']." kg/mt.sq."?></b></p><br>
              
              <p style="color:black;">BMI is a measure of body fat based on height and weight that applies to adult men and women.</p>
             <br>
...
<div class="container">
  ...
  <!--picture section-->
     ...
     <div class="healthy">
   <h3>Some Healthier nuts and vegetables</h3>
   </div>
