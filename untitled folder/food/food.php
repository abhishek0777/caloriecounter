...
<html>
<head>
	<link rel="stylesheet" href="foodmenu.css" type="text/css">
            ...
            <nav class="navbar">
                ...
                <ul>
                    <li ><a href="../home.php" ><i class="fa fa-home"></i>Home</a> 
                        ...
                        <!--    </ul>-->
                        <!--</div></li>-->
                    <li ><a href="food.php" class="active"><i class="fa fa-cutlery"></i>  Food</a>
                         </li>
...
<div>
   <ul class="menu">
       <li><a href="ofood.html">How Many Calories Should I Eat a Day?</a></li>
       <li><a href="protein.html">Should You Follow a High-Protein Diet?</a></li>
       <li><a href="food.html">Calories in Common Food</a></li>
   </ul>
</div>
